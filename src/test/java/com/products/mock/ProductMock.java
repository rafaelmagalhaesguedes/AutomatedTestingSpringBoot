...
/**
 * Mocks of product data
 */
public class ProductMock {
    public static Product PRODUCT = new Product("Product 01", "Product description.", CategoryType.AUTOMOTIVE, 10L, new BigDecimal("100"));
    public static Product INVALID_PRODUCT = new Product("", "", CategoryType.SPORT, 10L, new BigDecimal("11"));
